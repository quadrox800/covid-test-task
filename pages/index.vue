<template>
    <div v-if="!coockieChecked" class="flex flex-col items-center justify-center min-h-screen">
      <div role="status">
...
export default defineComponent({
  ...
  setup() {
    ...
    const handleLogin = () => {
        if (email.value === 'test123@mail.com' && password.value === 'passwordtest123') {
            isLoggedIn.value = true;
            Cookies.set('isLoggedIn', isLoggedIn.value);
            errorMessage.value = ''
        } else {
